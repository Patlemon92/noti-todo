            ...
            return (
              <li key={p.id}>
                <button
                  ...
                  className="block w-full rounded-[14px] border-2 border-ink bg-surface px-3.5 py-3 text-left shadow-card-sm transition-transform active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
                >
